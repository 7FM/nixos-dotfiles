  ...
  config = lib.mkIf enable {
    ...
    xdg =
      ...
      in
      {
        ...
        dataFile."FreeCAD/Macro/rotate_and_duplicate.FCMacro".source =
          ../../configs/freecad/Macro/rotate_and_duplicate.FCMacro;
        dataFile."FreeCAD/Macro/spreadsheet_alias_to_left.FCMacro".source =
          ../../configs/freecad/Macro/spreadsheet_alias_to_left.FCMacro;
        dataFile."FreeCAD/Macro/show_all_constraints.FCMacro".source =
          ../../configs/freecad/Macro/show_all_constraints.FCMacro;
        dataFile."FreeCAD/Macro/hide_all_constraints.FCMacro".source =
          ../../configs/freecad/Macro/hide_all_constraints.FCMacro;
        dataFile."FreeCAD/Macro/hide_zero_constraints.FCMacro".source =
          ../../configs/freecad/Macro/hide_zero_constraints.FCMacro;
        dataFile."FreeCAD/Macro/hide_geometry_constraints.FCMacro".source =
          ../../configs/freecad/Macro/hide_geometry_constraints.FCMacro;
      };
  };
}
