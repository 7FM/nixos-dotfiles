...
export default {
    ...
    color: {
        red: Option('#BF616A', { 'scss': 'red' }),
        green: Option('#A3BE8C', { 'scss': 'green' }),
        yellow: Option('#EBCB8B', { 'scss': 'yellow' }),
        blue: Option('#5E81AC', { 'scss': 'blue' }),
        magenta: Option('#B48EAD', { 'scss': 'magenta' }),
        teal: Option('#8FBCBB', { 'scss': 'teal' }),
        orange: Option('#D08770', { 'scss': 'orange' }),
    },
