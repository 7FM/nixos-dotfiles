...
lib.mkMerge [
  ...
  }
  {
    ...
    # Enable swap on luks
    boot.initrd.luks.devices."luks-f775e6dc-1800-4ef4-8a47-5f24e0a7fc2d".device =
      "/dev/disk/by-uuid/f775e6dc-1800-4ef4-8a47-5f24e0a7fc2d";
    boot.initrd.luks.devices."luks-f775e6dc-1800-4ef4-8a47-5f24e0a7fc2d".keyFile =
      "/crypto_keyfile.bin";

    boot.initrd.luks.devices."luks-a06e8b12-a88a-4700-b23e-0a38ef1f2884".device =
      "/dev/disk/by-uuid/a06e8b12-a88a-4700-b23e-0a38ef1f2884";
    ...
    services.udev = {
      ...
      extraRules = ''
        ...
        SUBSYSTEM=="usb", ATTRS{idVendor}=="057e", ATTRS{idProduct}=="0305", MODE="0666", TAG+="uaccess"
      '';
    };
