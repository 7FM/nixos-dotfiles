    ...
    services.klipper = {
      ...
      settings =
        ...
        rec {
          ...
          safe_z_home = {
            home_xy_position = "${builtins.toString (stepper_x.position_max / 2 - bltouch.x_offset)}, ${
              builtins.toString (stepper_y.position_max / 2 - bltouch.y_offset)
            }";
            speed = 50;
            z_hop = 10;
            z_hop_speed = 5;
          ...
          bed_mesh = {
            ...
            mesh_max = "${builtins.toString (stepper_x.position_max - 10)}, ${
              builtins.toString (stepper_y.position_max - 10)
            }";
            probe_count = 5;
          };
          ...
          "tmc2208 extruder" = (tmc2208Conf "PD2") // {
            run_current = 0.650;
          };
